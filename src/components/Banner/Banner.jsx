            ...
            <div data>
              <img
                ...
                className="max-w-[450px] h-[350px] w-full
                    mx-auto drop-shadow-[5px_5px_12px_rgba(0,0,0,0.7)] object-cover"
              />
            </div>
            {/* text content section */}
            <div>
              <h1 data-aos="fade-up" className="text-3xl font sm:text-4xl">Explore all corners of the world with us</h1>
              <p data-aos="fade-up" className="text-sm text-gray-500 tracking-wide leading-8">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                Maiores voluptatibus magni pariatur? Nihil, quam error nesciunt
                quas quo officia! Aliquam!
              </p>
              <div data-aos="zoom-in" className="grid grid-cols-2 gap-6">
                ...
                <div className="space-y-6">
                    <div className="flex items-center gap-4">
                        <IoIosWifi className="text-4xl h-12 w-12 shadow-sm
                        p-4 rounded-full bg-green-100 dark:bg-green-400"/>
                        <p>Wi-Fi</p>
                    </div>
                    <div className="flex items-center gap-4">
                        <IoFastFoodSharp className="text-4xl h-12 w-12 shadow-sm
