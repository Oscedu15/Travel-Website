            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 py-3">
              ...
              <div>
                ...
                <input
                  ...
                  name="destination"
                  id="destination"
                  className="w-full !placeholder-slate-400 bg-gray-100 my-2 rounded-full focus:outline-primary
                  focus:outline outline-1 p-2"
                />
              </div>
              <div>
                ...
                <div className=" bg-gray-100 rounded-full p-2 flex items-center justify-center ">
                  <input
                    ...
                    value={priceValue}
                    step="10"
                    // step especifica los intervalos de números permitidos para un elemento
